...
namespace SerializedDictionaries
{
    ...
    {
        private SerializedDictionary<TK, TV> _Dictionary;
        ...
        private void CheckInitialize(SerializedProperty property, GUIContent label)
        {
            if (_Dictionary == null)
            {
                ...
                _Dictionary = fieldInfo.GetValue(target) as SerializedDictionary<TK, TV>;
                if (_Dictionary == null)
                {
                    _Dictionary = new SerializedDictionary<TK, TV>();
